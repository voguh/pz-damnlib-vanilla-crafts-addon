...
local function swapPartsForVehicle(vehicleId)
    ...
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "SeatMiddleLeft", parts.heavyDutySeats);
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "SeatMiddleRight", parts.heavyDutySeats);
