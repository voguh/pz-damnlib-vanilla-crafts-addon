...
local function swapPartsForVehicle(vehicleId)
    ...
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "GT500SpareTire", parts.sportTires);
...
local function onLoad()
    if DAMNVanillaPartsAddon:enableFor("67gt500") then
        swapPartsForVehicle("Base.67gt500");
        swapPartsForVehicle("Base.67gt500e");
    end
end
