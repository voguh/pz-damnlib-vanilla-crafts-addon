...
local function swapPartsForVehicle(vehicleId)
    ...
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "CUDASpareTire", parts.sportTires);
...
local function onLoad()
    if DAMNVanillaPartsAddon:enableFor("70barracuda") then
        swapPartsForVehicle("Base.70barracuda");
        swapPartsForVehicle("Base.70barracudaAAR");
        swapPartsForVehicle("Base.70cuda");
    end
end
