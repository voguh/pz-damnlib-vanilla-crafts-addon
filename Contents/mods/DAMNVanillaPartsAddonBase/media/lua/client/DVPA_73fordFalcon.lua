...
local function swapPartsForVehicle(vehicleId)
    ...
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "DAMNSpareTireRoof", parts.sportTires);
...
local function onLoad()
    if DAMNVanillaPartsAddon:enableFor("73fordFalcon") then
        swapPartsForVehicle("Base.73fordFalconPSlhd");
        swapPartsForVehicle("Base.73fordFalconPS");
        swapPartsForVehicle("Base.73fordFalconXBGTlhd");
        swapPartsForVehicle("Base.73fordFalconXBGT");
    end
end
