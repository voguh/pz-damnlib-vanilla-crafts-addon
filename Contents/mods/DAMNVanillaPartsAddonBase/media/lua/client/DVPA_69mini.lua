...
local function swapPartsForVehicle(vehicleId)
    ...
    DAMNVanillaPartsAddon:replaceVehiclePart(vehicleId, "MINI69SpareTire", parts.standardTires);
...
local function onLoad()
    if DAMNVanillaPartsAddon:enableFor("69mini") then
        swapPartsForVehicle("Base.69mini");
        swapPartsForVehicle("Base.69miniIJ");
        swapPartsForVehicle("Base.69miniMrB");
        swapPartsForVehicle("Base.69miniPS");
        swapPartsForVehicle("Base.69miniUnionJack");
    end
end
